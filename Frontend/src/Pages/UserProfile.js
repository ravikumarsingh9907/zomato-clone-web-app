...
export async function loader({ params }) {
    ...
    const profileResponse = await fetch(`http://localhost:3333/users/${params.id}`, {
        method: 'GET',
    });
    ...
    const profilePictureResponse = await fetch(`http://localhost:3333/users/${params.id}/avatar`, {
        method: 'GET',
    });
...
export async function action({ request, params }) {
    const followResponse = await fetch(`http://localhost:3333/users/${params.id}/follow`, {
